 ...
 */
public class revicionDDHHFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =         inflater.inflate(R.layout.fragment_revicion_ddhh, container, false);
